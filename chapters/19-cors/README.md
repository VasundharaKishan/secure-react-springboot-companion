# Chapter 19 — CORS Configuration (worked examples)
...
- allowedOriginPatterns(*) plus credentials
- reflecting Origin header
- public endpoint with credentials
- CORS-enabled CSRF on JSON
...
Cross-reference Chapter 19 of the book for the conceptual explanation
