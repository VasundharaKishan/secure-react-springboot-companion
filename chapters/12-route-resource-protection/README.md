# Chapter 12 — Route and Resource Protection (worked examples)
...
- React route guard without server check
- requestMatchers ordering bypass
...
Cross-reference Chapter 12 of the book for the conceptual explanation
