# Chapter 24 — Secure File Upload and Download (worked examples)
...
- Extension-only check (.jsp)
- download path traversal
- zip bomb
- SVG with script tag
- signed S3 URL without expiry
...
Cross-reference Chapter 24 of the book for the conceptual explanation
