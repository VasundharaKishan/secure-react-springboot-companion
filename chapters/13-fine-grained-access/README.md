# Chapter 13 — Fine-Grained Access Control (worked examples)
...
- SpEL injection via @PreAuthorize
- ACL parent-only with no child ACL
...
Cross-reference Chapter 13 of the book for the conceptual explanation
