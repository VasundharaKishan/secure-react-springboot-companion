# Chapter 31 — Logging, Monitoring, and Incident Response (worked examples)
...
- Lombok @ToString leaking password
- full request headers shipped to SaaS
- PII in stack trace ticket
- alerts in unmonitored channel
- expired SIEM cert
...
Cross-reference Chapter 31 of the book for the conceptual explanation
