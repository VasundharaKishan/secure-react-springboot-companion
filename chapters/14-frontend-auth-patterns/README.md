# Chapter 14 — Frontend Authentication Patterns (worked examples)
...
- JWT in localStorage stolen by XSS
- refresh token race/theft
- auth state in React DevTools
- useEffect redirect race flash
...
Cross-reference Chapter 14 of the book for the conceptual explanation
