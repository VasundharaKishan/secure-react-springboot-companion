# Chapter 27 — Dependency and Supply Chain Security (worked examples)
...
- Outdated Log4j (Log4Shell)
- typosquat npm package
- malicious postinstall
- unpinned Docker base
...
Cross-reference Chapter 27 of the book for the conceptual explanation
