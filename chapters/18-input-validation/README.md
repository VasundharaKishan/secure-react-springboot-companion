# Chapter 18 — Input Validation and Sanitization (worked examples)
...
- Unbounded String DoS
- email regex header injection
- missing @Valid
- client-only validation bypass
...
Cross-reference Chapter 18 of the book for the conceptual explanation
