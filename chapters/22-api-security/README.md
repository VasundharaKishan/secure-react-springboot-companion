# Chapter 22 — API Security Fundamentals (worked examples)
...
- BOLA on /users/{id}/orders
- mass assignment of isAdmin
- sequential ID enumeration
- stack trace with DB credentials
...
Cross-reference Chapter 22 of the book for the conceptual explanation
