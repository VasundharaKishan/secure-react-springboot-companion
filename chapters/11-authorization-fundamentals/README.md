# Chapter 11 — Authorization Fundamentals (worked examples)
...
- Missing @PreAuthorize on controller
- JS-only role check
- any-authenticated-user-can-edit BOLA
- getPrincipal toString for authz
...
Cross-reference Chapter 11 of the book for the conceptual explanation
