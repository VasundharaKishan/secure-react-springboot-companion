# Chapter 16 — Cross-Site Request Forgery (CSRF) (worked examples)
...
- Globally disabled CSRF
- GET endpoint mutating state
- SameSite=None without CSRF token
- CSRF token leaked via Referer
...
Cross-reference Chapter 16 of the book for the conceptual explanation
