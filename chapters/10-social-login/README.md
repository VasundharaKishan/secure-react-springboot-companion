# Chapter 10 — Social Login and SSO (worked examples)
...
- Auto-account-link by email takeover
- email_verified=false accepted
- IdP downgrade attack
...
Cross-reference Chapter 10 of the book for the conceptual explanation
