# Chapter 30 — DevSecOps Pipeline (worked examples)
...
- GITHUB_TOKEN exposed to fork PR
- root container escape
- SCA gates set to warn
- Terraform public S3
- CI deploys without approval
...
Cross-reference Chapter 30 of the book for the conceptual explanation
