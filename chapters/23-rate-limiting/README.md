# Chapter 23 — Rate Limiting and Throttling (worked examples)
...
- No login limit (credential stuffing)
- IP-only limit (botnet bypass)
- missing reset-flow limit
- expensive export endpoint DoS
...
Cross-reference Chapter 23 of the book for the conceptual explanation
