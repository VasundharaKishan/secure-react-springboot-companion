# Chapter 6 — Spring Security Configuration (worked examples)
...
- Misconfigured permitAll() exposing actuator
- CSRF disabled cross-origin attack
- non-constant-time API key comparison
- filter-chain ordering bypass
...
Cross-reference Chapter 6 of the book for the conceptual explanation
