# Chapter 28 — Security Testing Fundamentals (worked examples)
...
- SAST suppressions hiding bugs
- @WithMockUser masking missing @PreAuthorize
- H2 hides Postgres-specific SQLi
- DAST scan blocked by login
...
Cross-reference Chapter 28 of the book for the conceptual explanation
