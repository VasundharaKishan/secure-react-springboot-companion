# Chapter 15 — Cross-Site Scripting (XSS) (worked examples)
...
- DOM XSS via innerHTML from URL hash
- dangerouslySetInnerHTML sanitizer bypass
- Thymeleaf th:utext
...
Cross-reference Chapter 15 of the book for the conceptual explanation
