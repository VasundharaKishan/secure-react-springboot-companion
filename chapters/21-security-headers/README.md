# Chapter 21 — Security Headers and Transport (worked examples)
...
- TLS 1.0/1.1 enabled
- HTTP-to-HTTPS redirect leaks cookie
...
Cross-reference Chapter 21 of the book for the conceptual explanation
