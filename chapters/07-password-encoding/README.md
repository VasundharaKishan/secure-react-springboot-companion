# Chapter 7 — Password Encoding and Storage (worked examples)
...
- Global salt
- MD5/SHA1 in production
- bcrypt cost factor 4
...
Cross-reference Chapter 7 of the book for the conceptual explanation
