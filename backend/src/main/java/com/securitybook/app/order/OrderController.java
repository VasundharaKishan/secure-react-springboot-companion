...
//
// Chapter 22 BOLA (Broken Object-Level Authorization): the path /api/users/{id}/orders
// must verify the authenticated principal owns {id} (or is an admin) before returning.
// The vulnerable version skips that check entirely.
